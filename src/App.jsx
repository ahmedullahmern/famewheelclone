  ...
  return (
    <div className="">
      ...
      <div style={{ backgroundImage: `url(${karachi})` }} className="relative h-[530px] bg-cover bg-center" >
        ...
        <div className='bg-red-900 relative z-10 lg:bg-transparent'>
          <div className='container mx-auto px-8 md:px-20 w-full items-center flex justify-between p-2 text-white'>
        ...
        {/* tarnsparent header */}
        <>
          <div className="fixed top-11 left-1/2 transform -translate-x-1/2 w-[90%] max-w-7xl bg-white/20 backdrop-blur-md z-50 p-5 rounded-[50px_50px_0_50px] hidden md:flex items-center justify-between px-10">
          ...
          <div className="relative top-0 left-0 w-full bg-white shadow-md p-4 flex justify-center md:hidden z-50">
        ...
        {/* hero section */}
        <div className="relative flex justify-center items-center mt-10 md:mt-28 lg:mt-32 px-4 text-center">
          <div className="max-w-[90%] sm:max-w-[80%] md:max-w-[70%] z-10">
            <h1 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white">
              Discover, Buy & Sell Cars in Pakistan
            </h1>
            <p className="font-medium text-sm sm:text-lg md:text-xl lg:text-2xl text-[#F8F9FA] mt-3">
        ...
        {/* search box */}
        <div className="relative flex justify-center items-center mt-12 sm:mt-16 md:mt-20 lg:mt-24 px-4">
          <div className="absolute top-[100%] sm:top-[90%] md:top-[80%] lg:top-[70%] w-full max-w-4xl bg-white p-4 rounded-lg shadow-lg flex flex-col md:flex-row md:items-center gap-4">
            <div className="w-full md:flex-1">
              <input
                type="text"
                placeholder="Select Make"
                className="border border-gray-300 px-4 py-3 rounded-md outline-none w-full"
              />
            </div>
            <div className="w-full md:flex-1">
              <input
            ...
            <div className="flex w-full md:w-auto gap-2">
              <button className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-md w-full md:w-auto">
                Search
              </button>
              <button className="border border-gray-500 hover:bg-gray-600 hover:text-white text-gray-700 px-6 py-3 rounded-md w-full md:w-auto">
                Advance Search
              </button>
            </div>
          </div>
        ...
        < div className="container mx-auto px-4 grid  grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-64  md:mt-36 lg:mt-32" >
          {
            cardsData.map((data) => (
              <a
                href="#"
